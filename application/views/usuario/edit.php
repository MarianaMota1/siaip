    ...
    <div class="bs-callout">
        <div class="row">
            <div class="col-md-6">
                ...
                <?php } ?>
                <?= form_open('usuario/edit') ?>
                <div class='row'>
					<div class='col-md-12'>
						<div class="form-group">
							<?= form_label('NOME', 'nome') ?>
							<?= form_input(['id' => 'nome', 'name' => 'nome', 'class' => 'form-control', 'placeholder' => 'NOME', 'autofocus' => true], set_value('nome', $usuario['nome'])) ?>
						</div>
					</div>
					<div class='col-md-12'>
						<div class="form-group">
							<?= form_label('EMAIL', 'email') ?>
							<?= form_input(['id' => 'email', 'name' => 'email', 'class' => 'form-control', 'placeholder' => 'EMAIL'], set_value('email', $usuario['email'])) ?>
						</div>
					</div>
					<div class='col-md-6'>
						<div class="form-group">
