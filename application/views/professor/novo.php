                    ...
                    <div class="form-group">
                        <table class="table table-bordered">
                            ...
                            <?php foreach ($disciplinas as $key => $value) { ?>
                                <tr>
                                    <td>
                                        <label id="disciplinaLABEL<?= $value['id'] ?>"><?= $value['nome'] ?></label>
                                        <input type="hidden" id="disciplinaNOME<?= $value['id'] ?>" value="<?= $value['nome'] ?>">
                                        <input type="hidden" id="disciplinaNOMEBEGIN<?= $value['id'] ?>" value="<?= $value['nome'] ?>">
                                    </td>
                                    <td align="center">
                                        <div id="turma<?= $value['id'] ?>"></div>
                                        <input type="hidden" id="countTURMA<?= $value['id'] ?>" name="countTURMA<?= $value['id'] ?>" value="0">
                                        <input type="checkbox" name="disciplina<?= $value['id'] ?>"
                                                              id="disciplina<?= $value['id'] ?>"
                                                              onclick="ckDisciplina('<?= $value['id'] ?>')" value="SIM">
                                    </td>
                                </tr>
                            <?php } ?>
                            </tbody>
